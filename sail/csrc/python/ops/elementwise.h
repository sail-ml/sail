...
RETURN_OBJECT ops_add(PyObject* self, PyObject* args) {
    ...
    ret_class->tensor =
        sail::ops::add(((PyTensor*)t1)->tensor, ((PyTensor*)t2)->tensor);
...
RETURN_OBJECT ops_sub(PyObject* self, PyObject* args) {
    ...
    ret_class->tensor =
        sail::ops::subtract(((PyTensor*)t1)->tensor, ((PyTensor*)t2)->tensor);
    // std::cout << (ret_class->tensor.fcn)->getName() << std::endl;
...
RETURN_OBJECT ops_mul(PyObject* self, PyObject* args) {
    ...
    ret_class->tensor =
        sail::ops::multiply(((PyTensor*)t1)->tensor, ((PyTensor*)t2)->tensor);
    // std::cout << (ret_class->tensor.fcn)->getName() << std::endl;
...
RETURN_OBJECT ops_div(PyObject* self, PyObject* args) {
    ...
    ret_class->tensor =
        sail::ops::divide(((PyTensor*)t1)->tensor, ((PyTensor*)t2)->tensor);
    // std::cout << (ret_class->tensor.fcn)->getName() << std::endl;
